...
class Simulator:
    ...
    def _init_robot_properties(self) -> None:
        ...
        self.actuators_names = ["rj_dg_1_1_ctrl", "rj_dg_1_2_ctrl", "rj_dg_1_3_ctrl", "rj_dg_1_4_ctrl",
        ...
        self.actuator_ids = np.array([self.model.actuator(name).id for name in self.actuators_names])
        
        # Task space properties
        self.site_name = "rl_dg_mount_site"
    ...
    def _init_default_actuators(self, mode="position") -> None:
        """Initialize default actuator configuration (torque control)."""
        # Default torque ranges for UR5e joints (in Nm)
        default_effort_ranges = {
            'rj_dg_1_1_ctrl': [-300, 300],
            'rj_dg_1_2_ctrl': [-300, 300],
            'rj_dg_1_3_ctrl': [-300, 300],
            'rj_dg_1_4_ctrl': [-300, 300],
            'rj_dg_2_1_ctrl': [-300, 300],
            'rj_dg_2_2_ctrl': [-300, 300],
            'rj_dg_2_3_ctrl': [-300, 300],
            'rj_dg_2_4_ctrl': [-300, 300],
            'rj_dg_3_1_ctrl': [-300, 300],
            'rj_dg_3_2_ctrl': [-300, 300],
            'rj_dg_3_3_ctrl': [-300, 300],
            'rj_dg_3_4_ctrl': [-300, 300],
            'rj_dg_4_1_ctrl': [-300, 300],
            'rj_dg_4_2_ctrl': [-300, 300],
            'rj_dg_4_3_ctrl': [-300, 300],
            'rj_dg_4_4_ctrl': [-300, 300],
            'rj_dg_5_1_ctrl': [-300, 300],
            'rj_dg_5_2_ctrl': [-300, 300],
            'rj_dg_5_3_ctrl': [-300, 300],
            'rj_dg_5_4_ctrl': [-300, 300],
        }
        ...
        default_position_ranges = {
            'rj_dg_1_1_ctrl': [-0.384, 0.890],
            'rj_dg_1_2_ctrl': [-3.142, 0.0],
            'rj_dg_1_3_ctrl': [-1.571, 1.571],
            'rj_dg_1_4_ctrl': [-1.571, 1.571],
            'rj_dg_2_1_ctrl': [-0.419, 0.611],
            'rj_dg_2_2_ctrl': [0.0, 2.007],
            'rj_dg_2_3_ctrl': [-1.571, 1.571],
            'rj_dg_2_4_ctrl': [-1.571, 1.571],
            'rj_dg_3_1_ctrl': [-0.611, 0.611],
            'rj_dg_3_2_ctrl': [0.0, 1.955],
            'rj_dg_3_3_ctrl': [-1.571, 1.571],
            'rj_dg_3_4_ctrl': [-1.571, 1.571],
            'rj_dg_4_1_ctrl': [-0.611, 0.419],
            'rj_dg_4_2_ctrl': [0.0, 1.902],
            'rj_dg_4_3_ctrl': [-1.571, 1.571],
            'rj_dg_4_4_ctrl': [-1.571, 1.571],
            'rj_dg_5_1_ctrl': [-0.017, 1.047],
            'rj_dg_5_2_ctrl': [-0.419, 0.611],
            'rj_dg_5_3_ctrl': [-1.571, 1.571],
            'rj_dg_5_4_ctrl': [-1.571, 1.571],
        }
        
        if mode == "torque":
            self.actuator_configs: Dict[str, ActuatorMotor] = {}
            for name in self.actuators_names:
                self.actuator_configs[name] = ActuatorMotor(torque_range=default_effort_ranges[name])
        elif mode == "position":
            self.actuator_configs: Dict[str, ActuatorPosition] = {}
            for name in self.actuators_names:
                self.actuator_configs[name] = ActuatorPosition(kp=default_stiffness[name], kd=default_damping[name], position_range=default_position_ranges[name])
